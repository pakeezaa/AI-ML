...
df=pd.read_csv('FeatureScaling/Social_Network_Ads.csv')
#print(df.head(4))
...
plt.savefig('FeatureScaling/scaling.png',dpi=300,bbox_inches='tight')
plt.show()
...
plt.savefig('FeatureScaling/kdeplot.png',dpi=300,bbox_inches='tight')
plt.show()
